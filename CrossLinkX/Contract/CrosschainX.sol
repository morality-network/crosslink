...
interface IERC20 {
    ...
    */ 
     ...
     * a call to {MoveToken}.
     */
    event MovedToken(uint256 id, string toChain, address indexed owner, string addressTo, uint256 fee, uint256 amount);
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    */ 
    function moveToken(uint256 amount, string memory toChain, string memory addressTo) public virtual payable override returns (bool){
        ...
        // Kick off the event
        emit MovedToken(_getMovedTokenId(), toChain, _msgSender(), addressTo, msg.value, amount);
